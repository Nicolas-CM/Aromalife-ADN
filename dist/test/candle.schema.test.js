...
const candle_schema_1 = require("../schemas/candle.schema");
describe("CandleCustomization Schema", () => {
    it("debe requerir URL de imagen válida", () => {
        ...
        const result = candle_schema_1.candleCustomizationSchema.safeParse(invalidData);
    ...
    it("debe permitir mensajes de IA opcionales", () => {
        ...
        expect(() => candle_schema_1.candleCustomizationSchema.parse(validData)).not.toThrow();
    });
